...
public class Math_Sub : MonoBehaviour
{
    ...
    private int Skor_Sub, HSkor_Sub;
    public Text SkorKu_Sub, SkorKuF_Sub, HSkorKu_Sub;
    ...
    void Start(){
        Skor_Sub = 0;
        SkorKu_Sub.text = "Skor : " + Skor_Sub;

        textWriter.AddWriter(msgText, "Sudah siap menjawab soal pengurangan ?", .1f, true);
    }
    ...
    public void Problem(string operation){
        ...
        if(VarOperation == "subtraction"){
            Operation.text = "-";
        }
        
        //Random Answer 
        tempNumber = Random.Range(2, 40);
        while(tempNumber == finalAns){
            tempNumber = Random.Range(2,40);
        }
        Answer1 = tempNumber;

        tempNumber = Random.Range(2, 25);
        while((tempNumber == finalAns) || (tempNumber == Answer1)){
            tempNumber = Random.Range(2,25);
        }
        Answer2 = tempNumber;

        tempNumber = Random.Range(2, 15);
    ...
    private void Timer(){
        if(timerActive){
            ...
            if(GameAktif && Waktu <= 0){
                ...
                SkorKuF_Sub.text = "Skor : " + Skor_Sub;

                if(Skor_Sub >= PlayerPrefs.GetInt("HSkor_Sub"))
                {
                    PlayerPrefs.SetInt("HSkor_Sub", Skor_Sub);
                }
                HSkorKu_Sub.text = "High Skor : " + PlayerPrefs.GetInt("HSkor_Sub");
